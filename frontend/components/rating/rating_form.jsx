...
class RatingForm extends React.Component{
    ...
    componentDidMount(){
        this.props.fetchHouse(this.state.house_id)
    ...
    handleSubmit(e){
       ...
       )).then( () => this.props.history.push(`/houses/${this.props.match.params.id}`))
    }
        ...
        return(
            <div className="rating-div">
                <div className="rating-header">
                    <Link to={`/houses/${this.props.house.id}`} >
                        <i className="fas fa-angle-double-left"></i> Back To {this.props.house.name}
                    </Link>
                </div>
                <div className="rating-form-container">
                    <div className="rating-rest-info">
                        <img className="img-sml" src={this.props.house.photo}/>
                        <div className="rating-house-text">
                            <div className="res-rest-name">
                                {this.props.house.name}
                            </div>
                            <br/>
                            <i className="fas fa-utensils"></i> {this.props.house.type} | <i className="fas fa-map-marker-alt location-idx"></i> {this.props.house.type}
                        </div>
                    </div>
