...
import AllHouse from './all_houses'
...
class MapSearch extends React.Component {
  ...
  sendBounds(sw, ne) {
    ...
    this.props.searchHouses({ bounds })
  }
  ...
  render() {
    const { houses, fetchHouses, searchHouses } = this.props;
      ...
      <div id="search-map-page">
        <div className="search-map-container">
          ...
          <div className="search-rest-container">
            ...
            <AllHouse houses={houses} searchHouses={searchHouses} />
          </div>
        </div>
      </div>
    )
